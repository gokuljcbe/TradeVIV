...
public class AdminBaseClass {
	...
	public static List<String> readExcel(String sheetName) throws IOException {
		...
		try {
			...
			alaigalSheet = alaigalWorkbook.getSheet(sheetName);
	...
	public void AdminSetUp() {
		driver = BrowserFactory.startApplication(driver, "Chrome", adminURL);
	}
